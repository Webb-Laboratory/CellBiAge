...
parser.add_argument('--num_capsule', type=int, default=8, help='number of the primary capsule')
parser.add_argument('--weights', type=str, default='Modelweight.weight', help='trained weights')
parser.add_argument('--PC', type=int, default=12, help='indicate which principle component will be analyzed ')
parser.add_argument('--Primary_capsule', type=int, default=0, help='indicate which primary capsule will be analyzed')
...
encoders.append(Model(x_in, x1))
# x1 = Dropout(0.2)(x1)
x2 = Dense(128, activation='relu')(x1)
encoders.append(Model(x_in, x2))
# x2 = Dropout(0.2)(x2)
x3 = Dense(64, activation='relu')(x2)
encoders.append(Model(x_in, x3))
# # x3 = Dropout(0.2)(x3)
