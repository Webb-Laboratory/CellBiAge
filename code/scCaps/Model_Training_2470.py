...
# system config
parser.add_argument('--inputdata', type=str, default='data_Neuron.npy', help='address for input data')
parser.add_argument('--inputcelltype', type=str, default='data_Neuron_celltype.npy', help='address for celltype label')
parser.add_argument('--num_classes', type=int, default=2, help='number of cell type')
parser.add_argument('--randoms', type=int, default=66, help='random number to split dataset')
...
x = Reshape((8, z_dim))(x)
capsule = Capsule(num_classes, 8, 3, False)(x) 
